            ...
            <tr class="success" >
              ...
              <tr>
               ...
               <td> <button type="button" class="bt1 caw"><strong> {{$row->created_at}}</strong></button></td>
                <td><a href="{{route('view_all_cleansed',['id'=>$row->id_running])}}"><button data-toggle="modal" data-target=".bd-example-modal-lg" class="bt1 biti" type="button" class="btn btn-info">View The Results </button></a></td>
              </tr>
              @endforeach
            </table>
