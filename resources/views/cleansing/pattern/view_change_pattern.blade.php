...
<div class="row">
  <div class="col-lg-12">
    <h3 class="page-header"><strong>Change Pattern Modul</strong></h3>
...
<br><br>
  ...
  <hr>
        <form method="post" action="{{ url('/cleansing/pattern/change_pattern_process') }}">
          {{ csrf_field() }}
        <div>
              ...
              <br>
                  ...
                  <input type="hidden" class="form-control" name="id_running" value="{{$id_running}}"><br>
                      ...
                      <br><br><input style="margin-left:20px;" type="checkbox" name="cleansed" value="cleansed"> &nbsp&nbsp&nbsp<strong>Accept to change the pattern</strong><br>
                          ...
                          <br><br>
                          <button style="width:50%;margin-left:20px;" data-toggle="modal" data-target=".bd-example-modal-lg" class="bt1 bita">Execution</button>
                      </div>
                    </form>
                  </div>
        </div>
