...
<div class="row">
  <div class="col-lg-12">
    <h3 class="page-header"><strong>Punctuation Pattern Modul</strong></h3>

  </div>
  </div><!--/.row-->

<div class="bs-callout bs-callout-success">
<a class="" href="{{url('cleansing/pattern/pattern_punctuation')}}"><button data-toggle="modal" data-target=".bd-example-modal-lg" type="button"class="bt1 back btn-lg active"><i class="fa fa-angle-double-left" style="font-size:25px;color:#000000"></i> &nbsp Back</button></a> &nbsp&nbsp
<a class="" href="{{url('cleansing/pattern/pattern_change')}}"><button data-toggle="modal" data-target=".bd-example-modal-lg" type="button"class="bt1 skip btn-lg active"> Next to Change Pattern  &nbsp <i class="fa fa-angle-double-right" style="font-size:25px;color:#000000"></i></button></a> &nbsp&nbsp
...
<br><br>
  ...
  <hr>
        <form method="post" action="{{ url('/cleansing/pattern/punctuation_pattern_process') }}">
          {{ csrf_field() }}
        <div>
              ...
              <br></div>
                  ...
                  <input type="hidden" class="form-control" name="id_running" value="{{$id_running}}"><br>
                        <input class="w3-input  w3-animate-input" placeholder="New Pattern"  name="new_string" type="text" style="width:50%">                         -->                  
                          ...
                          <br>
                          <input class="bt1 siti"  type="button" style="width:40%;margin-left:90px;" class="form-control" name="id_running" value="You Are Deleting the Punctuation With Id Running: {{$id_running}}">
