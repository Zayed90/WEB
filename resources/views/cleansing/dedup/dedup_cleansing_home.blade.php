...
<div class="row">
  <form method="post" action="{{ url('/cleansing/dedup/choose-dedup') }}" enctype="multipart/form-data">
          ...
          <table data-toggle="table" data-show-refresh="true" data-search="true" data-pagination="true">
            ...
            <tr class="success">
              ...
              <tr>
                ...
                <td><a href="{{route('dedup_cleansing_view',['id'=>$row->id_running])}}"<button type="button" class="btn btn-success">See Result</button></a></td>
              </tr>
              @endforeach
            </table>
          </div>
