...
<div class="row">
  <ol class="breadcrumb">
    ...
    <li><a href="{{url('/cleansing_mdm/punctuation')}}">Remove Punctuation</a></li>
...
<div class="row">
  <div class="col-lg-12">
    <h1 class="page-header">Remove Punctuation</h1>
  </div>
</div><!--/.row-->
...
<div class="row">
  ...
  @endif
  <form method="post" action="{{ url('/cleansing_mdm/punctuation/process') }}" enctype="multipart/form-data">
    <div class="col-xs-12 col-md-6 col-lg-12">
      ...
      <div class="bs-callout bs-callout-primary">
        ...
        <div class="col-xs-12 col-md-6 col-lg-6">
        <div class="form-group">
            <label for="exampleInputEmail1">Primary Key Column</label>
            <input type="text" class="form-control" name="pkey">
            <small class="form-text text-muted">Enter primary key column name to be used in this process.</small>
        </div>
        </div>
        <div class="col-xs-12 col-md-6 col-lg-6">
          <div class="form-group">
...
<div class="bs-callout bs-callout-success">
  <h4>Data Completeness Result</h4>
  <hr>
  <div class="row">
    <div class="col-lg-12">
          ...
          <table data-toggle="table" data-show-refresh="true" data-search="true" data-pagination="true">
            ...
            <tr class="success">
              ...
              <tr>
                ...
                <td><a href="{{route('viewPunctuation',['id'=>$row->id_running])}}"<button type="button" class="btn btn-success">See Result</button></a></td>
              </tr>
              @endforeach
            </table>
          </div>
