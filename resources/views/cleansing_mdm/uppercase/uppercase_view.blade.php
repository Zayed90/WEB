...
<div class="row">
  <ol class="breadcrumb">
      ...
      <li><a href="{{url('/cleansing_mdm/uppercase')}}">Uppercase</a></li>
...
<div class="row">
  <div class="col-lg-12">
    <h1 class="page-header">View Uppercase</h1>
  </div>
</div><!--/.row-->
  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="panel panel-default">
        ...
        <a href="{{route('uppercase')}}"<button type="button" class="btn btn-success btn-block">Back</button></a>
      </div>
    </div>
  </div>
