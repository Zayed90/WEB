...
<div class="row">
  <ol class="breadcrumb">
    ...
    <li><a href="{{url('/pentaho/dataCompleteness')}}">Uppercase</a></li>
...
<div class="row">
  <div class="col-lg-12">
    <h1 class="page-header">Change to Uppercase</h1>
  </div>
</div><!--/.row-->
...
<div class="row">
  ...
  @endif
  <form method="post" action="{{ url('/cleansing_mdm/uppercase/process') }}" enctype="multipart/form-data">
          ...
          <table data-toggle="table" data-show-refresh="true" data-search="true" data-pagination="true">
            ...
            <tr class="success">
              ...
              <tr>
                ...
                <td><a href="{{route('viewUppercase',['id'=>$row->id_running])}}"<button type="button" class="btn btn-success">See Result</button></a></td>
              </tr>
              @endforeach
            </table>
          </div>
