...
<div class="row">
  <div class="col-lg-12">
    <h1 class="page-header">Run Clustering</h1>
  </div>
</div><!--/.row-->
...
<div class="row">
  ...
  @endif
  <form method="post" action="{{ url('/pentaho/clustering/process') }}" enctype="multipart/form-data">
            ...
            <table data-toggle="table" data-show-refresh="true" data-search="true" data-pagination="true">
              ...
              <tr class="success">
                ...
                <tr>
                  ...
                  <td><a href="{{route('clusteringView',['id'=>$row->id_running])}}"<button type="button" class="btn btn-success">See Result</button></a></td>
                </tr>
                @endforeach
              </table>
            </div>
