...
<div class="row">
  <div class="col-lg-12">
    <h1 class="page-header">Run Value Distribution</h1>
  </div>
</div><!--/.row-->
...
<div class="row">
  ...
  @endif
  <form method="post" action="{{ url('/pentaho/valueDistribution/process') }}" enctype="multipart/form-data">
      ...
      <div class="bs-callout bs-callout-primary">
        ...
        <div class="col-xs-12 col-md-6 col-lg-6">
            {{-- <div class="form-group">
              ...
              <small class="form-text text-muted">Enter label name to be used in this process.</small>
            </div> --}}
          </div>
      </div>
...
<div class="bs-callout bs-callout-success">
  <h4>Value Distribution Result</h4>
  <hr>
  <div class="row">
    <div class="col-lg-12">
          ...
          <table data-toggle="table" data-show-refresh="true" data-search="true" data-pagination="true">
            ...
            <tr class="success">
              ...
              <tr>
                ...
                <td><a href="{{route('valueDistributionView',['id'=>$row->id_running])}}"<button type="button" class="btn btn-success">See Result</button></a></td>
              </tr>
              @endforeach
            </table>
          </div>
