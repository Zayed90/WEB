...
<div class="row">
  <div class="col-lg-12">
    <h1 class="page-header">Run Show Null</h1>
  </div>
</div><!--/.row-->
...
<div class="row">
  ...
  @endif
  <form method="post" action="{{ url('/pentaho/shownull/process') }}" enctype="multipart/form-data">
    <div class="col-xs-12 col-md-6 col-lg-12">
      ...
      <div class="bs-callout bs-callout-primary">
        ...
        <div class="col-xs-12 col-md-6 col-lg-6">
          <div class="form-group">
            <label for="exampleInputEmail1">Company Name Column</label>
            <input type="text" class="form-control" name="companyColumn">
            <small class="form-text text-muted">Enter company name column to be used in this process.</small>
          </div>
          </div>
        <div class="col-xs-12 col-md-6 col-lg-6">
          <div class="form-group">
          ...
          <table data-toggle="table" data-show-refresh="true" data-search="true" data-pagination="true">
            ...
            <tr class="success">
              ...
              <tr>
                ...
                <td><a href="{{route('shownullView',['id'=>$row->id_running])}}"<button type="button" class="btn btn-success">See Result</button></a></td>
              </tr>
              @endforeach
            </table>
          </div>
