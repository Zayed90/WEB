...
<div class="bs-callout bs-callout-success">
    ...
    > Type Information
    VALID : Checked value is same as is from Dictionary
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <a href="{{route('completenessMonitorView')}}"<button type="button" class="btn btn-block btn-success">Back</button></a>
        </div>
    </div>
</div>
