                        ...
                        @foreach($results as $row)
                            ...
                            @else
                                <tr>
                                    ...
                                    <td><a href="{{route('clusteringViewDGPO',['id'=>$row->id_running])}}"<button type="button" class="btn btn-success">See Result</button></a></td>
                                </tr>
                                @endforeach
                    </table>
                </div>
...
<script type="text/javascript">
    $(function(){
        ...
        $.getJSON("http://127.0.0.1:8000/monitoring/clusteringmonitoringdata", function(mps)
        {
            $("#output").pivotUI(mps,
                {
                    rows: ["clustering_value"],
                    vals:["total"],
                    aggregatorName: "Sum",
